...
using Neo.Plugins.Example.Exceptions;
using Neo.Plugins.Example.Models;
using Neo.SmartContract.Native;
using System.Net.Mime;

namespace Neo.Plugins.Example.Controllers
{
    [Route("/api/v1")] // <-- Route/Directory URL (can be new or add to existing)
    ...
    [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(ErrorModel))] // <-- Must put this on each controller you have. So Swagger knows the default error type model.
