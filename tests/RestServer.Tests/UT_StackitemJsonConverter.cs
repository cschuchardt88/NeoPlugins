...
namespace RestServer.Tests
{
    public class UT_StackitemJsonConverter
    {
        ...
        public void Test_StackItem_Write_And_Read_JsonConverter()
        {
            ...
            var json = JsonConvert.SerializeObject(a, RestServerSettings.Default.JsonSerializerSettings);
            var siObject = JsonConvert.DeserializeObject<StackItem>(json, RestServerSettings.Default.JsonSerializerSettings);
